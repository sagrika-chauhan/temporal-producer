...
/**
 * All features pertaining to atmosphere control on an environment controlled asset.
 * e.g. a reefer container, a reefer truck, a cold storage warehouse, commodity etc.
 */
@Builder
public class AtmosphereControl {
  ...
  @NonNull private AtmosphereControlProperties atmosphereControlProperties;
}
